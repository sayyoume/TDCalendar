...
std::wstring CStrEncrypt::WStringEncrypt(const std::wstring& srwstr, int srclen)   //Unicode字符串加密 
{
...
std::wstring CStrEncrypt::WStringDecrypt(const std::wstring& srwstr)                   //Unicode字符串解密
{
    std::string strtemp = JTerse::core::ws2s(srwstr);
