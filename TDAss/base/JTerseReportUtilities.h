...
enum ELangAreaID
{
	...
	LA_MM_MM				= 0x0455,		//0x0455 Burmese
	LA_MAX					= 0xFFFF,
};
...
namespace JTerse{ namespace core{ namespace ReportLog{
	...
	class APDDLL_DECLSPEC ReportUtilities
	{
	public:
		ReportUtilities(){}
		~ReportUtilities(){}
		...
		// iIndex=1,获得国家
		// iIndex=2,获得语言
		static void GetNationLanguage(std::wstring& strOut, int iIndex);
		static DWORD ReportUtilities::GetLCIDbyNation(std::wstring& strOut);
		static std::wstring getContory();
	...
	BOOL APDDLL_DECLSPEC GetNtVersionNumbers(DWORD& dwMajorVer, DWORD& dwMinorVer, DWORD& dwBuildNumber);

	bool APDDLL_DECLSPEC Is64();
