    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		//树控件XML解析
            ...
            case 7:
				...
				else if (_tcscmp(pstrClass, L"ComboEx") == 0)				  pControl = new CComboExUI;
				else if (_tcscmp(pstrClass, _T("LabelEx")) == 0)			  pControl = new CLabelEx;
                break;
            case 8:
				...
				else if (_tcscmp(pstrClass, L"OptionEx")	  == 0)			  pControl = new COptionExUI;
                break;
            case 9:
