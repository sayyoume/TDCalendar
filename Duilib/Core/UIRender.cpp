                                    ...
                                    BYTE uFade, bool hole, bool xtiled, bool ytiled)
{
 ...
 bool CRenderEngine::DrawImage(HDC hDC, CPaintManagerUI* pManager, const RECT& rcItem, const RECT& rcPaint, TDrawInfo& drawInfo)
 {
	 ...
	 myDrawImage(hDC, drawInfo.pImageInfo->hBitmap, rcDest, rcPaint, drawInfo.rcBmpPart, drawInfo.rcScale9,
		 drawInfo.pImageInfo->alphaChannel, drawInfo.uFade, drawInfo.bHole, drawInfo.bTiledX, drawInfo.bTiledY);
	 return true;
 }

 void CRenderEngine::myDrawImage(HDC hDC, HBITMAP hBitmap, const RECT& rc, const RECT& rcPaint, 
									const RECT& rcBmpPart, const RECT& rcScale9, bool alphaChannel,
									BYTE uFade, bool hole, bool bTiledX, bool bTiledY)
 {
	 ASSERT(::GetObjectType(hDC) == OBJ_DC || ::GetObjectType(hDC) == OBJ_MEMDC);
