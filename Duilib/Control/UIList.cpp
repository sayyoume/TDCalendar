...
CListLabelElementUI::CListLabelElementUI():m_nFont(-1)
{
}
...
void CListLabelElementUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	if (_tcscmp(pstrName, _T("textpadding")) == 0)
	{
        ...
        m_nFont = _ttoi(pstrValue);
    }
	CListElementUI::SetAttribute(pstrName, pstrValue);
}


RECT CListLabelElementUI::GetTextPadding() const
{
	return m_textPadding;
}

void CListLabelElementUI::SetTextPadding(RECT rc)
{
	m_textPadding = rc;
	Invalidate();
}
